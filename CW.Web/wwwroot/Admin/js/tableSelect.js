    ...
    */
    tableSelect.prototype.render = function (opt) {
        ...
        elem.off('click').on('click', function(e) {
            ...
            //控制是否显示数据列表  数值同步广告管理页面跳转类型下拉框value
            if (opt.dataType == '' || opt.dataType == '100' || opt.dataType == '-1' || opt.dataType == '201' || opt.dataType == '3301' || opt.dataType == '4401' || opt.dataType == '501' || opt.dataType == '599'
                || opt.dataType == '601' || opt.dataType == '605' || opt.dataType == '608' || opt.dataType == '701' || opt.dataType == '801' || opt.dataType == '221' || opt.dataType == '231' || opt.dataType == '132'
                || opt.dataType == '8800' || opt.dataType == '8017' || opt.dataType == '8005' || opt.dataType == '8009' || opt.dataType == '8002' || opt.dataType == '8036'
                || opt.dataType == '9200' || opt.dataType == '9201' || opt.dataType == '9202' || opt.dataType == '9203' || opt.dataType == '9204' || opt.dataType == '9205' || opt.dataType == '9206' || opt.dataType == '9207' || opt.dataType == '9300' || opt.dataType == '9301') {
                return false;
            }
