...
layui.define(["jquery"], function (t) {
    ...
    ! function (t) {
        ...
        function a(e, n, a) {
            ...
            if (!(e.which > 1 || e.metaKey || e.ctrlKey || e.shiftKey || e.altKey || location.protocol !== r.protocol ||
                location.hostname !== r.hostname || r.href.indexOf("#") > -1 && m(r) == m(location) || e.isDefaultPrevented())) {
                var i = {
                    url: r.href,
                ...
                t(r).trigger(c, [s]), c.isDefaultPrevented() || (o(s), e.preventDefault(), t(r).trigger("pjax:clicked", [
                        s]))
            }
        }
        function r(e, n, a) {
            ...
            if ("GET" !== i.type && void 0 !== window.FormData) i.data = new FormData(r), i.processData = !1, i.contentType = !
                    1;
            else {
        ...
        function o(e) {
            ...
            e.beforeSend = function (t, a) {
                if ("GET" !== a.type && (a.timeout = 0), t.setRequestHeader("X-PJAX", "true"), t.setRequestHeader(
                    "X-PJAX-Container", i.selector), !n("pjax:beforeSend", [t, a])) return !1;
            ...
            return u.readyState > 0 && (e.push && !e.replace && (b(o.state.id, f(i)), window.history.pushState(null, "",
                e.requestUrl)), n("pjax:start", [u, e]), n("pjax:send", [u, e])), o.xhr
        }
        function i(e, n) {
            var a = {
                url: window.location.href,
        ...
        function y(e, n, a) {
            ...
            else s = c = t(j(e)); if (0 === c.length) return r;
            if (r.title = g(s, "title").last().text(), a.fragment) {
                if ("body" === a.fragment) u = c;
                else var u = g(c, a.fragment).first();
                u.length && (r.contents = "body" === a.fragment ? u : u.contents(), r.title || (r.title = u.attr(
                    "title") || u.data("title")))
            } else o || (r.contents = c);
            return r.contents && (r.contents = r.contents.not(function () {
                return t(this).is("title")
            }), r.contents.find("title").remove(), r.scripts = g(r.contents, "script[src]").remove(), r.contents = r.contents
                .not(r.scripts)), r.title && (r.title = t.trim(r.title)), r
        }
        function w(e) {
            if (e) {
                var n = t("script[src]");
        ...
        function T(t, e, n) {
            var a, r;
            R[e] = n, "forward" === t ? (a = X, r = U) : (a = U, r = X), a.push(e), (e = r.pop()) && delete R[e], E(a,
                o.defaults.maxCacheLength)
        }
        function E(t, e) {
        ...
        function P() {
            t.fn.pjax = n, t.pjax = o, t.pjax.enable = t.noop, t.pjax.disable = C, t.pjax.click = a, t.pjax.submit = r,
                t.pjax.reload = i, t.pjax.defaults = {
                    timeout: 650,
                    push: !0,
                    replace: !1,
                    type: "GET",
        ...
        function C() {
            t.fn.pjax = function () {
                return this
            }, t.pjax = u, t.pjax.enable = P, t.pjax.disable = t.noop, t.pjax.click = t.noop, t.pjax.submit = t.noop, t
        ...
        var R = {}, U = [],
            X = [];
        t.inArray("state", t.event.props) < 0 && t.event.props.push("state"), t.support.pjax = window.history && window
            .history.pushState && window.history.replaceState && !navigator.userAgent.match(
            /((iPod|iPhone|iPad).+\bOS\s+[1-4]\D|WebApps\/.+CFNetwork)/), t.support.pjax ? P() : C()
    }(e), t("pjax")
});