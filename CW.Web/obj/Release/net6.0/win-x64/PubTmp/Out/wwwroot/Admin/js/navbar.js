...
layui.define(["layer", "laytpl", "element"], function(i) {
    ...
    i("navbar", {
        v: "1.0.2", config: { data: void 0, remote: { url: void 0, type: "GET", jsonp: !1 }, cached: !1, elem: void 0, filter: "kitNavbar" },
        set: function(i) {
            var a = this;
        ...
        bind: function(i) {
            ...
            return t.find("a[kit-target]").each(function() {
                ...
                t.hover(function() { n = a.tips(e(this).children("span").text(), this) }, function() { n && a.close(n) }), t.off("click").on("click", function() {
