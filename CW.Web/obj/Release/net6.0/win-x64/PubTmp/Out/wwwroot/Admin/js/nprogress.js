...
layui.define(function (n) {
    ! function (e, t) {
        "function" == typeof define && define.amd ? define(t) : "object" == typeof n ? module.exports = t() : e.NProgress =
            t()
    }(this, function () {
        function n(n, e, t) {
        ...
        u.configure = function (n) {
            ...
            var t = u.status;
            return t ? ("number" != typeof e && (e = (1 - t) * n(Math.random() * t, .1, .95)), t = n(t + e, 0, .994), u
                .set(t)) : u.start()
        }, u.trickle = function () {
        ...
        function () {
            ...
            }), c.showSpinner || (r = t.querySelector(c.spinnerSelector)) && a(r), l != document.body && i(l,
                "nprogress-custom-parent"), l.appendChild(t), t
        }, u.remove = function () {
            s(document.documentElement, "nprogress-busy"), s(document.querySelector(c.parent),
            ...
            var n = document.body.style,
                e = "WebkitTransform" in n ? "Webkit" : "MozTransform" in n ? "Moz" : "msTransform" in n ? "ms" :
                    "OTransform" in n ? "O" : "";
        ...
        var l = function () {
            ...
            f = function () {
                ...
                function e(n) {
                    ...
                    if (n in e) return n;
                    for (var t, r = i.length, s = n.charAt(0).toUpperCase() + n.slice(1) ; r--;) if ((t = i[r] + s) in e)
                        return t;
                    return n
                }
                function t(t) {
        ...
        return u
    }), layui.link("../../Admin/css/nprogress.css"), n("nprogress")
});